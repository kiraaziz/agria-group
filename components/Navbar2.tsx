            ...
            >
                {!open && (
                    ...
                    <i className="group fas fa-bars flex flex-row items-center justify-center gap-2">
                        <FaBars className="w-10 group-hover:w-0 ease-in-out duration-200 overflow-hidden text-white" />
                        <h1 className='w-0 overflow-hidden ease-in-out duration-200 bg-lime-400/40 text-white group-hover:w-20 hover:bg-lime-400/60'>Menu</h1>
                    </i>
                )
                }
            </button>
            <div className={`h-[100svh] ${open ? "w-screen opacity-100" : "w-0 opacity-0"} top-0 left-0  ease-in duration-300 absolute bg-[#E9FFC2] flex items-center justify-center gap-4 z-50 `}>
                <button
                    onClick={() => setOpen(!open)}>
                    <i className="group fas fa-bars flex flex-row items-center justify-center gap-2">
                        <LiaTimesSolid size={25} className="w-10 group-hover:w-0 ease-in-out duration-200 overflow-hidden" />
                        <h1 className='w-0 overflow-hidden ease-in-out duration-200 bg-lime-400/40 text-white group-hover:w-20 hover:bg-lime-400/60'>Close</h1>
                    </i>
                </button>
